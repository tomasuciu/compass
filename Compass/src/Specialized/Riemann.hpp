...
class RiemannAlgebraic : private RiemannBase, public SpecializedFit<RiemannAlgebraic> {
    ...
    protected:
        RiemannAlgebraic& compute(const Eigen::Ref<const DataMatrixD>& data) {
            ...
            // TODO: Avoid addl allocation of memory, merge Zp.transpose() * centered into single vectorized matrix operation
            ...
            // TODO: It might be possible to calculate A2 and A3 in one single sweep
